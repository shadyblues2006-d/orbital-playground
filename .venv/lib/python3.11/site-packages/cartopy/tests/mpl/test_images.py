...
REGIONAL_IMG = (
    config["repo_data_dir"] / "raster" / "sample" / "Miriam.A2012270.2050.2km.jpg"
)
...
@pytest.mark.natural_earth
@pytest.mark.mpl_image_compare(filename="imshow_regional_projected.png", tolerance=1.97)
