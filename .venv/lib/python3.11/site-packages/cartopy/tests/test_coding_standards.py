...
REPO_DIR = Path(os.getenv("CARTOPY_GIT_DIR", CARTOPY_DIR.parent.parent))
...
class TestLicenseHeaders:
    ...
    def list_tracked_files():
        ...
        output = subprocess.check_output(
            ["git", "ls-tree", "-z", "-r", "--name-only", "HEAD"], cwd=REPO_DIR
        )
    ...
    def test_license_headers(self):
        ...
        try:
            ...
            return pytest.skip(
                "cartopy installation did not look like a git " f"repo: {e}"
            )
