...
class TestLambertAzimuthalEqualArea:
    def test_default(self):
        ...
        assert_almost_equal(
            np.array(crs.x_limits), [-12755636.1863, 12755636.1863], decimal=4
        )
        assert_almost_equal(
            np.array(crs.y_limits), [-12727770.598700099, 12727770.598700099], decimal=4
        )
    ...
    def test_eccentric_globe(self):
        ...
        assert_almost_equal(np.array(crs.x_limits), [-1999.9, 1999.9], decimal=1)
        assert_almost_equal(
    ...
    def test_offset(self):
        crs = ccrs.LambertAzimuthalEqualArea()
        crs_offset = ccrs.LambertAzimuthalEqualArea(
