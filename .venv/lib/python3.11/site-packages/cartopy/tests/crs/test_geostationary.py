...
class TestGeostationary:
    ...
    def test_default(self):
        ...
        assert_almost_equal(
            geos.boundary.bounds,
            (-5434177.81588539, -5412932.3767, 5434177.81588539, 5412932.3767),
            decimal=4,
        )
    ...
    def test_low_orbit(self):
        ...
        assert_almost_equal(
            geos.boundary.bounds,
            (-785616.1189, -783815.6629, 785616.1189, 783815.6629),
            decimal=4,
        )

        # Checking that this isn't just a simple elliptical border
        assert_almost_equal(
            geos.boundary.coords[7], (750051.0347, -305714.8243), decimal=4
        )
    ...
    def test_eastings(self):
        ...
        assert_almost_equal(
            geos.boundary.bounds,
            (-434177.81588539, -5537932.3767, 10434177.81588539, 5287932.3767),
            decimal=4,
        )
