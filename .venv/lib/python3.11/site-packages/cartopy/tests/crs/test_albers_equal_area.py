...
class TestAlbersEqualArea:
    def test_default(self):
        ...
        assert_almost_equal(
            np.array(aea.x_limits), [-17702759.799178038, 17702759.799178038], decimal=0
        )
        assert_almost_equal(
            np.array(aea.y_limits), [-4782937.05107294, 15922623.93176938], decimal=4
        )
    ...
    def test_eccentric_globe(self):
        ...
        assert_almost_equal(
            np.array(aea.x_limits), [-2323.47073363411, 2323.47073363411], decimal=-2
        )
        assert_almost_equal(
            np.array(aea.y_limits), [-572.556243423972, 2402.36176984391], decimal=10
        )

    def test_eastings(self):
        aea_offset = ccrs.AlbersEqualArea(false_easting=1234, false_northing=-4321)
    ...
    def test_sphere_transform(self):
        ...
        assert_almost_equal(
            np.array(aea.x_limits), [-2.6525072042232, 2.6525072042232], decimal=3
        )
        assert_almost_equal(
            np.array(aea.y_limits), [-1.09628087472359, 2.39834724057551], decimal=10
        )
    ...
    def test_ellipsoid_transform(self):
        ...
        assert_almost_equal(
            np.array(aea.x_limits), [-16900972.674607, 16900972.674607], decimal=-3
        )
        assert_almost_equal(
            np.array(aea.y_limits), [-6971893.11311231, 15298166.8919989], decimal=1
        )
