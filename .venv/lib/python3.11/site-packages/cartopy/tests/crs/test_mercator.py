...
def test_default():
    ...
    assert_almost_equal(
        crs.boundary.bounds, [-20037508, -15496571, 20037508, 18764656], decimal=0
    )
...
def test_eccentric_globe():
    ...
    other_args = {"a=10000", "b=5000", "lon_0=0.0", "x_0=0.0", "y_0=0.0", "units=m"}
    check_proj_params("merc", crs, other_args)

    assert_almost_equal(
        crs.boundary.bounds, [-31415.93, -2190.5, 31415.93, 2190.5], decimal=2
    )
...
def test_central_longitude(lon):
    ...
    assert_almost_equal(
        crs.boundary.bounds, [-20037508, -15496570, 20037508, 18764656], decimal=0
    )
...
def test_latitude_true_scale():
    ...
    assert_almost_equal(
        crs.boundary.bounds, [-18836475, -14567718, 18836475, 17639917], decimal=0
    )
...
def test_easting_northing():
    ...
    assert_almost_equal(
        crs.boundary.bounds, [-19037508, -17496571, 21037508, 16764656], decimal=0
    )
