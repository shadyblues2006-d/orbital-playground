...
@pytest.mark.parametrize(
    "name, proj, radius, expected_x, expected_y",
    [
...
@pytest.mark.parametrize(
    "name, proj, lim, expected",
    [
        # USGS Professional Paper 1395, pg 368
        pytest.param(
            "eck4", ccrs.EckertIV, 2.65300085, [0.1875270, -0.9519210], id="EckertIV"
        ),
        # USGS Professional Paper 1395, pg 369
        pytest.param(
            "eck6", ccrs.EckertVI, 2.77096497, [0.1693623, -0.9570223], id="EckertVI"
        ),
    ],
)
