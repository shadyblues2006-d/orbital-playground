...
class TestStereographic:
    def test_default(self):
        ...
        assert_almost_equal(np.array(stereo.x_limits), [-5e7, 5e7], decimal=3)
        assert_almost_equal(np.array(stereo.y_limits), [-5e7, 5e7], decimal=3)
    ...
    def test_eccentric_globe(self):
        ...
        # reasonable map.
        assert_almost_equal(
            np.array(stereo.x_limits), [-7839.27971444, 7839.27971444], decimal=4
        )
        assert_almost_equal(
    ...
    def test_scale_factor(self):
        ...
        globe = ccrs.Globe(ellipse="sphere")
        stereo = ccrs.Stereographic(
            central_latitude=90.0, scale_factor=0.75, globe=globe
        )
        other_args = {
            "ellps=sphere",
            "lat_0=90.0",
