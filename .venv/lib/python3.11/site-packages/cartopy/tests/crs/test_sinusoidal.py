...
class TestSinusoidal:
    def test_default(self):
        ...
        assert_almost_equal(
            np.array(crs.x_limits), [-20037508.3428, 20037508.3428], decimal=4
        )
        assert_almost_equal(
            np.array(crs.y_limits), [-10001965.7293, 10001965.7293], decimal=4
        )
    ...
    def test_eccentric_globe(self):
        ...
        assert_almost_equal(np.array(crs.x_limits), expected_x, decimal=2)
        assert_almost_equal(np.array(crs.y_limits), expected_y, decimal=2)
    ...
    def test_MODIS(self):
        ...
        assert_almost_equal(
            crs.transform_points(crs.as_geodetic(), lons, lats),
